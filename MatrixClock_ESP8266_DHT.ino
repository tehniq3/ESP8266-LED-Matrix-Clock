...
// DHT sensor
#define DHTPIN 12     // what pin we're connected to // GPIO 13 = D6
...
//    umiditate = random(1,55);
 ...
 char2Arr(' ', d_PosX-5, 0);
poz = 11;
            char2Arr(WT_arr[MEZ.WT][0], d_PosX - poz, 0);        //day of the week
            char2Arr(WT_arr[MEZ.WT][1], d_PosX - poz-6, 0);
            char2Arr(WT_arr[MEZ.WT][2], d_PosX - poz-12, 0);
            char2Arr(WT_arr[MEZ.WT][3], d_PosX - poz-18, 0);
 char2Arr(' ', d_PosX - poz-24, 0);          
            char2Arr(48 + MEZ.tag2, d_PosX - poz-30, 0);           //day
            char2Arr(48 + MEZ.tag1, d_PosX - poz-36, 0);
 char2Arr('-', d_PosX - poz-42, 0);     

            char2Arr(M_arr[MEZ.mon12 - 1][1], d_PosX - poz-48, 0);
            char2Arr(M_arr[MEZ.mon12 - 1][2], d_PosX - poz-54, 0);
            char2Arr(M_arr[MEZ.mon12 - 1][3], d_PosX - poz-60, 0);
                 
  char2Arr('-', d_PosX - poz-66, 0);
            char2Arr('2', d_PosX - poz-72, 0);                     //year
            char2Arr('0', d_PosX - poz-78, 0);
            char2Arr(48 + MEZ.jahr2, d_PosX - poz-84, 0);
            char2Arr(48 + MEZ.jahr1, d_PosX - poz-90, 0);
            
            char2Arr(' ', d_PosX - poz-96, 0);
            char2Arr(' ', d_PosX - poz-102, 0);
            char2Arr(' ', d_PosX - poz-108, 0);
...
if (temperatura >= 10)  
    {
      char2Arr('+', d_PosX - poz2, 0);                    //temperature
      char2Arr(48 + (temperatura / 10), d_PosX - poz2-6, 0);
      char2Arr(48 + (temperatura % 10), d_PosX - poz2-12, 0);
      char2Arr('$', d_PosX - poz2-18, 0);
      char2Arr('C', d_PosX - poz2-24, 0);
    } 
if (temperatura <= 9 && temperatura >0)     
    {
      char2Arr(' ', d_PosX - poz2, 0);                    //temperature
      char2Arr('+', d_PosX - poz2-6, 0);
      char2Arr(48 + (temperatura % 10), d_PosX - poz2-12, 0);
      char2Arr('$', d_PosX - poz2-18, 0);
      char2Arr('C', d_PosX - poz2-24, 0);
    }    
...
if (temperatura < 0 && temperatura >= -9)
    {
      char2Arr(' ', d_PosX - poz2, 0);                    //temperature
      char2Arr('-', d_PosX - poz2-6, 0);//the ,,abs,, turns the negative number into positive
      char2Arr(48 + (abs(temperatura) % 10), d_PosX - poz2-12, 0);
      char2Arr('$', d_PosX - poz2-18, 0);
      char2Arr('C', d_PosX - poz2-24, 0);
    }     
if (temperatura <  -9)
    {
      char2Arr('-', d_PosX - poz2, 0);                    //temperature
      char2Arr(48 + (abs(temperatura) / 10), d_PosX - poz2-6, 0);//the ,,abs,, turns the negative number into positive
      char2Arr(48 + (abs(temperatura) % 10), d_PosX - poz2-12, 0);
      char2Arr('$', d_PosX - poz2-18, 0);
      char2Arr('C', d_PosX - poz2-24, 0);
    } 
            char2Arr(' ', d_PosX - poz2-30, 0);
            char2Arr(' ', d_PosX - poz2-36, 0);
  //          char2Arr(' ', d_PosX - poz2-44, 0);

if (umiditate >= 10)  
    {
      char2Arr(48 + (umiditate / 10), d_PosX - poz2-42, 0);
      char2Arr(48 + (umiditate % 10), d_PosX - poz2-48, 0);
      char2Arr('%', d_PosX - poz2-54, 0);
      char2Arr('R', d_PosX - poz2-60, 0);
      char2Arr('H', d_PosX - poz2-66, 0);
    } 
if (temperatura <= 9 && temperatura >0)     
    {
      char2Arr(' ', d_PosX - poz2-42, 0);
      char2Arr(48 + (umiditate), d_PosX - poz2-48, 0);
      char2Arr('%', d_PosX - poz2-54, 0);
      char2Arr('R', d_PosX - poz2-60, 0);
      char2Arr('H', d_PosX - poz2-66, 0);
    }    
char2Arr(' ', d_PosX - poz2-72, 0);
char2Arr(' ', d_PosX - poz2-78, 0);
char2Arr(' ', d_PosX - poz2-82, 0);
